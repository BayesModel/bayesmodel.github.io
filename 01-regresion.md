...
#> Time used:
#>     Pre = 2.23, Running = 0.148, Post = 0.0178, Total = 2.39 
#> Fixed effects:
...
fit$mlik
#>                                            [,1]
#> log marginal-likelihood (integration) -426.7482
#> log marginal-likelihood (Gaussian)    -426.7385
```
...
#> fitted.Predictor.001 76.52862 0.2162813   76.10403 76.52862
#> fitted.Predictor.002 51.61090 0.2441625   51.13157 51.61090
#> fitted.Predictor.003 54.48602 0.2190185   54.05605 54.48602
#> fitted.Predictor.004 69.82000 0.1750447   69.47636 69.82000
#> fitted.Predictor.005 59.27789 0.1856111   58.91350 59.27789
#> fitted.Predictor.006 75.57025 0.2087784   75.16038 75.57025
#>                      0.975quant mode
...
fit2$summary.fixed
#>                  mean         sd 0.025quant  0.5quant
#> (Intercept) 3.3857663 0.81564702  1.7941515 3.3823292
#> repwt       0.9488587 0.01215543  0.9248519 0.9489089
#>             0.975quant mode          kld
#> (Intercept)  4.9968569   NA 2.172800e-09
#> repwt        0.9725812   NA 2.109786e-09
fit2$summary.hyperpar
#>                                              mean
#> Precision for the Gaussian observations 0.1984234
#>                                                 sd
#> Precision for the Gaussian observations 0.02083252
#>                                         0.025quant
#> Precision for the Gaussian observations  0.1603296
#>                                          0.5quant
#> Precision for the Gaussian observations 0.1977207
#>                                         0.975quant mode
#> Precision for the Gaussian observations  0.2410785   NA
```
...
#>   1.751   3.089   3.610   3.633   4.162   5.736
...
#> (Intercept) 135.496 49.863     37.158  135.502    233.795
#> negtemp       1.769  0.634      0.518    1.769      3.020
#> manuf         0.026  0.005      0.017    0.026      0.035
#> wind         -3.723  1.935     -7.537   -3.724      0.093
...
#> Mean            15.671 
#> Stdev           1.85626 
#> Quantile  0.025 12.5308 
#> Quantile  0.25  14.3469 
#> Quantile  0.5   15.491 
#> Quantile  0.75  16.7979 
#> Quantile  0.975 19.8194
```
...
fit$summary.fixed
#>                     mean          sd   0.025quant
#> (Intercept) 100.01489169 30.13099371 40.596153290
#> negtemp       1.12025965  0.41417450  0.303554176
#> manuf         0.06489655  0.01548617  0.034363042
#> pop          -0.03934790  0.01487989 -0.068687708
#> wind         -3.07255433  1.75612360 -6.534277440
#> precip        0.41922183  0.21541620 -0.005534158
#>                 0.5quant   0.975quant mode          kld
#> (Intercept) 100.01851313 159.41292103   NA 1.159479e-08
#> negtemp       1.12028712   1.93680800   NA 1.162564e-08
#> manuf         0.06489630   0.09543149   NA 1.163918e-08
#> pop          -0.03934755  -0.01001010   NA 1.163829e-08
#> wind         -3.07281055   0.39063360   NA 1.156909e-08
#> precip        0.41922823   0.84394120   NA 1.163705e-08
fit$summary.hyperpar
#>                                                mean
#> Precision for the Gaussian observations 0.005066467
#>                                                  sd
#> Precision for the Gaussian observations 0.001178815
#>                                          0.025quant
#> Precision for the Gaussian observations 0.003036659
#>                                            0.5quant
#> Precision for the Gaussian observations 0.004975648
#>                                          0.975quant mode
#> Precision for the Gaussian observations 0.007618659   NA
```
...
#>                         mean       sd 0.025quant 0.5quant
#> fitted.Predictor.42 31.62386 8.206714   15.44274 31.62462
#> fitted.Predictor.43 26.42295 5.475609   15.62708 26.42331
#> fitted.Predictor.44 53.16294 7.093675   39.17661 53.16349
#>                     0.975quant mode
#> fitted.Predictor.42   47.80044   NA
#> fitted.Predictor.43   37.21661   NA
#> fitted.Predictor.44   67.14593   NA
```
