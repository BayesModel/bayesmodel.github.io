...
\CommentTok{\#\textgreater{} (Intercept) 2.734 0.815      1.135    2.734      4.333   NA}
...
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} Marginal log{-}Likelihood:  {-}426.75 }
...
\CommentTok{\#\textgreater{} log marginal{-}likelihood (integration) {-}426.7334}
\CommentTok{\#\textgreater{} log marginal{-}likelihood (Gaussian)    {-}426.7507}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\textgreater{} (Intercept) 2.7338111 0.81452014   1.134639 2.7338110}
\CommentTok{\#\textgreater{} repwt       0.9583742 0.01213864   0.934542 0.9583742}
\CommentTok{\#\textgreater{}             0.975quant mode          kld}
\CommentTok{\#\textgreater{} (Intercept)  4.3329837   NA 6.236972e{-}10}
\CommentTok{\#\textgreater{} repwt        0.9822063   NA 6.240827e{-}10}
\CommentTok{\# descriptivos varianza}
\NormalTok{fit}\SpecialCharTok{$}\NormalTok{summary.hyperpar}
\CommentTok{\#\textgreater{}                                              mean}
\CommentTok{\#\textgreater{} Precision for the Gaussian observations 0.1990541}
\CommentTok{\#\textgreater{}                                                 sd}
\CommentTok{\#\textgreater{} Precision for the Gaussian observations 0.02087189}
\CommentTok{\#\textgreater{}                                         0.025quant}
\CommentTok{\#\textgreater{} Precision for the Gaussian observations  0.1607532}
\CommentTok{\#\textgreater{}                                          0.5quant}
\CommentTok{\#\textgreater{} Precision for the Gaussian observations 0.1983142}
\CommentTok{\#\textgreater{}                                         0.975quant mode}
\CommentTok{\#\textgreater{} Precision for the Gaussian observations  0.2415604   NA}
\CommentTok{\# medias de los efectos fijos}
\NormalTok{fit}\SpecialCharTok{$}\NormalTok{summary.fixed}\SpecialCharTok{$}\NormalTok{mean}
\CommentTok{\#\textgreater{} [1] 2.7338111 0.9583742}
\CommentTok{\# descriptivos primer efecto fijo}
\NormalTok{fit}\SpecialCharTok{$}\NormalTok{summary.fixed[}\DecValTok{1}\NormalTok{,]}
\CommentTok{\#\textgreater{}                 mean        sd 0.025quant 0.5quant}
\CommentTok{\#\textgreater{} (Intercept) 2.733811 0.8145201   1.134639 2.733811}
\CommentTok{\#\textgreater{}             0.975quant mode          kld}
\CommentTok{\#\textgreater{} (Intercept)   4.332984   NA 6.236972e{-}10}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\textgreater{}                          mean        sd 0.025quant 0.5quant}
\CommentTok{\#\textgreater{} fitted.Predictor.001 76.52862 0.2163056   76.10398 76.52862}
\CommentTok{\#\textgreater{} fitted.Predictor.002 51.61089 0.2441899   51.13152 51.61089}
\CommentTok{\#\textgreater{} fitted.Predictor.003 54.48602 0.2190431   54.05600 54.48602}
\CommentTok{\#\textgreater{} fitted.Predictor.004 69.82000 0.1750644   69.47633 69.82000}
\CommentTok{\#\textgreater{} fitted.Predictor.005 59.27789 0.1856320   58.91346 59.27789}
\CommentTok{\#\textgreater{} fitted.Predictor.006 75.57025 0.2088019   75.16034 75.57025}
\CommentTok{\#\textgreater{}                      0.975quant mode}
\CommentTok{\#\textgreater{} fitted.Predictor.001   76.95326   NA}
\CommentTok{\#\textgreater{} fitted.Predictor.002   52.09027   NA}
\CommentTok{\#\textgreater{} fitted.Predictor.003   54.91603   NA}
\CommentTok{\#\textgreater{} fitted.Predictor.004   70.16368   NA}
\CommentTok{\#\textgreater{} fitted.Predictor.005   59.64231   NA}
\CommentTok{\#\textgreater{} fitted.Predictor.006   75.98016   NA}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\textgreater{}                 mean         sd 0.025quant 0.5quant}
\CommentTok{\#\textgreater{} (Intercept) 2.798268 0.81405670  1.2009796 2.797924}
\CommentTok{\#\textgreater{} repwt       0.957434 0.01213189  0.9336008 0.957439}
\CommentTok{\#\textgreater{}             0.975quant mode          kld}
\CommentTok{\#\textgreater{} (Intercept)  4.3975064   NA 6.346236e{-}10}
\CommentTok{\#\textgreater{} repwt        0.9812387   NA 6.336410e{-}10}
\NormalTok{fit2}\SpecialCharTok{$}\NormalTok{summary.hyperpar}
\CommentTok{\#\textgreater{}                                              mean}
\CommentTok{\#\textgreater{} Precision for the Gaussian observations 0.1991098}
\CommentTok{\#\textgreater{}                                                 sd}
\CommentTok{\#\textgreater{} Precision for the Gaussian observations 0.02085853}
\CommentTok{\#\textgreater{}                                         0.025quant}
\CommentTok{\#\textgreater{} Precision for the Gaussian observations  0.1609233}
\CommentTok{\#\textgreater{}                                          0.5quant}
\CommentTok{\#\textgreater{} Precision for the Gaussian observations 0.1984206}
\CommentTok{\#\textgreater{}                                         0.975quant mode}
\CommentTok{\#\textgreater{} Precision for the Gaussian observations  0.2417227   NA}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\textgreater{}                                 0.25266}
\NormalTok{sims[[}\DecValTok{1}\NormalTok{]]}\SpecialCharTok{$}\NormalTok{latent}
\CommentTok{\#\textgreater{}               sample:1}
\CommentTok{\#\textgreater{} (Intercept):1 2.541701}
\CommentTok{\#\textgreater{} repwt:1       0.963570}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\textgreater{} [1] 0.01541341}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $latent}
\CommentTok{\#\textgreater{} [1] 1006.117}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $joint}
\CommentTok{\#\textgreater{} [1] 1006.132}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\textgreater{} (Intercept) 135.488 49.841     37.197  135.496    233.739}
...
\CommentTok{\#\textgreater{} Mean            15.6707 }
\CommentTok{\#\textgreater{} Stdev           1.85545 }
\CommentTok{\#\textgreater{} Quantile  0.025 12.5294 }
\CommentTok{\#\textgreater{} Quantile  0.25  14.3455 }
\CommentTok{\#\textgreater{} Quantile  0.5   15.4924 }
\CommentTok{\#\textgreater{} Quantile  0.75  16.8001 }
\CommentTok{\#\textgreater{} Quantile  0.975 19.8144}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\textgreater{} (Intercept) 100.01536804 30.11937540 40.622035749}
\CommentTok{\#\textgreater{} negtemp       1.12026170  0.41401328  0.303906962}
\CommentTok{\#\textgreater{} manuf         0.06489654  0.01548017  0.034376013}
\CommentTok{\#\textgreater{} pop          {-}0.03934789  0.01487415 {-}0.068675287}
\CommentTok{\#\textgreater{} wind         {-}3.07258619  1.75544891 {-}6.532869818}
\CommentTok{\#\textgreater{} precip        0.41922019  0.21533255 {-}0.005355155}
\CommentTok{\#\textgreater{}                 0.5quant   0.975quant mode          kld}
\CommentTok{\#\textgreater{} (Intercept) 100.01888681 159.38860028   NA 1.159475e{-}08}
\CommentTok{\#\textgreater{} negtemp       1.12028845   1.93646384   NA 1.162531e{-}08}
\CommentTok{\#\textgreater{} manuf         0.06489628   0.09541853   NA 1.164025e{-}08}
\CommentTok{\#\textgreater{} pop          {-}0.03934754  {-}0.01002251   NA 1.163945e{-}08}
\CommentTok{\#\textgreater{} wind         {-}3.07283624   0.38912644   NA 1.156844e{-}08}
\CommentTok{\#\textgreater{} precip        0.41922670   0.84375842   NA 1.163746e{-}08}
\NormalTok{fit}\SpecialCharTok{$}\NormalTok{summary.hyperpar}
\CommentTok{\#\textgreater{}                                                mean}
...
\CommentTok{\#\textgreater{}                         mean       sd 0.025quant 0.5quant}
\CommentTok{\#\textgreater{} fitted.Predictor.42 31.62395 8.206793   15.44282 31.62470}
\CommentTok{\#\textgreater{} fitted.Predictor.43 26.42296 5.475660   15.62708 26.42331}
\CommentTok{\#\textgreater{} fitted.Predictor.44 53.16311 7.093772   39.17672 53.16365}
\CommentTok{\#\textgreater{}                     0.975quant mode}
\CommentTok{\#\textgreater{} fitted.Predictor.42   47.80055   NA}
\CommentTok{\#\textgreater{} fitted.Predictor.43   37.21663   NA}
\CommentTok{\#\textgreater{} fitted.Predictor.44   67.14617   NA}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\textgreater{}               mean    sd 0.025quant 0.5quant 0.975quant}
\CommentTok{\#\textgreater{} (Intercept) 61.017 1.173     58.697   61.016     63.340}
\CommentTok{\#\textgreater{} dietB        4.979 1.515      1.979    4.980      7.973}
\CommentTok{\#\textgreater{} dietC        6.977 1.515      3.977    6.978      9.971}
\CommentTok{\#\textgreater{} dietD       {-}0.016 1.437     {-}2.862   {-}0.016      2.825}
\CommentTok{\#\textgreater{}             mode kld}
\CommentTok{\#\textgreater{} (Intercept)   NA   0}
...
\CommentTok{\#\textgreater{} Probabilidad posterior de que muC\textgreater{}muB+2 = 0.491}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\textgreater{} [1] 120.4858}
...
\NormalTok{fit}\SpecialCharTok{$}\NormalTok{summary.fixed}
\CommentTok{\#\textgreater{}                             mean         sd  0.025quant}
\CommentTok{\#\textgreater{} (Intercept)            4.0077184 0.10124862  3.80873696}
\CommentTok{\#\textgreater{} BreedCanadian          0.3784787 0.13071139  0.12159356}
\CommentTok{\#\textgreater{} BreedGuernsey          0.8899744 0.13071139  0.63308907}
\CommentTok{\#\textgreater{} BreedHolstein{-}Fresian {-}0.3905147 0.13071139 {-}0.64739968}
\CommentTok{\#\textgreater{} BreedJersey            1.2324714 0.13071139  0.97558606}
\CommentTok{\#\textgreater{} AgeMature              0.1045993 0.08267011 {-}0.05787073}
\CommentTok{\#\textgreater{}                         0.5quant 0.975quant mode}
\CommentTok{\#\textgreater{} (Intercept)            4.0077182  4.2067009   NA}
\CommentTok{\#\textgreater{} BreedCanadian          0.3784790  0.6353627   NA}
\CommentTok{\#\textgreater{} BreedGuernsey          0.8899746  1.1468582   NA}
\CommentTok{\#\textgreater{} BreedHolstein{-}Fresian {-}0.3905145 {-}0.1336306   NA}
\CommentTok{\#\textgreater{} BreedJersey            1.2324717  1.4893552   NA}
\CommentTok{\#\textgreater{} AgeMature              0.1045993  0.2670693   NA}
\CommentTok{\#\textgreater{}                                kld}
\CommentTok{\#\textgreater{} (Intercept)           2.525010e{-}09}
\CommentTok{\#\textgreater{} BreedCanadian         2.524993e{-}09}
\CommentTok{\#\textgreater{} BreedGuernsey         2.524993e{-}09}
\CommentTok{\#\textgreater{} BreedHolstein{-}Fresian 2.524995e{-}09}
\CommentTok{\#\textgreater{} BreedJersey           2.525001e{-}09}
\CommentTok{\#\textgreater{} AgeMature             2.525225e{-}09}
\NormalTok{fit}\SpecialCharTok{$}\NormalTok{waic}\SpecialCharTok{$}\NormalTok{waic}
...
\NormalTok{fit}\SpecialCharTok{$}\NormalTok{summary.fixed}
\CommentTok{\#\textgreater{}                             mean         sd 0.025quant}
\CommentTok{\#\textgreater{} (Intercept)            4.0600181 0.09271801  3.8778057}
\CommentTok{\#\textgreater{} BreedCanadian          0.3784786 0.13112335  0.1207894}
\CommentTok{\#\textgreater{} BreedGuernsey          0.8899742 0.13112335  0.6322848}
\CommentTok{\#\textgreater{} BreedHolstein{-}Fresian {-}0.3905148 0.13112335 {-}0.6482039}
\CommentTok{\#\textgreater{} BreedJersey            1.2324713 0.13112335  0.9747818}
\CommentTok{\#\textgreater{}                         0.5quant 0.975quant mode}
\CommentTok{\#\textgreater{} (Intercept)            4.0600180  4.2422316   NA}
\CommentTok{\#\textgreater{} BreedCanadian          0.3784788  0.6361666   NA}
\CommentTok{\#\textgreater{} BreedGuernsey          0.8899745  1.1476621   NA}
...
\CommentTok{\#\textgreater{}                                kld}
\CommentTok{\#\textgreater{} (Intercept)           2.473637e{-}09}
\CommentTok{\#\textgreater{} BreedCanadian         2.473620e{-}09}
\CommentTok{\#\textgreater{} BreedGuernsey         2.473624e{-}09}
\CommentTok{\#\textgreater{} BreedHolstein{-}Fresian 2.473621e{-}09}
\CommentTok{\#\textgreater{} BreedJersey           2.473619e{-}09}
\NormalTok{fit}\SpecialCharTok{$}\NormalTok{waic}\SpecialCharTok{$}\NormalTok{waic}
...
\FunctionTok{round}\NormalTok{(fit}\SpecialCharTok{$}\NormalTok{summary.fixed,}\DecValTok{3}\NormalTok{)}
\CommentTok{\#\textgreater{}                  mean    sd 0.025quant 0.5quant 0.975quant}
\CommentTok{\#\textgreater{} (Intercept)    16.652 3.886      9.028   16.651     24.275}
\CommentTok{\#\textgreater{} Father          0.400 0.039      0.324    0.400      0.477}
\CommentTok{\#\textgreater{} Mother          0.307 0.045      0.218    0.307      0.396}
\CommentTok{\#\textgreater{} GenderM         2.708 5.427     {-}7.938    2.708     13.353}
...
\CommentTok{\#\textgreater{} [1] 0.9414417}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\textgreater{} 1  1  1.831222e{-}06 0.01224196 {-}0.02449432  1.159052e{-}06}
\CommentTok{\#\textgreater{} 2  2 {-}1.281854e{-}05 0.01224198 {-}0.02453430 {-}8.113280e{-}06}
\CommentTok{\#\textgreater{} 3  3  1.098734e{-}05 0.01224197 {-}0.02446939  6.954290e{-}06}
\CommentTok{\#\textgreater{}   0.975quant mode        kld}
\CommentTok{\#\textgreater{} 1 0.02450430   NA 0.01299272}
\CommentTok{\#\textgreater{} 2 0.02446442   NA 0.01299309}
\CommentTok{\#\textgreater{} 3 0.02452929   NA 0.01299299}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} $box}
\CommentTok{\#\textgreater{}   ID          mean          sd  0.025quant      0.5quant}
\CommentTok{\#\textgreater{} 1  1  6.021434e{-}06 0.006350497 {-}0.01291523  5.122419e{-}06}
\CommentTok{\#\textgreater{} 2  2 {-}3.452279e{-}06 0.006350496 {-}0.01292834 {-}2.936845e{-}06}
\CommentTok{\#\textgreater{} 3  3 {-}1.525439e{-}06 0.006350496 {-}0.01292567 {-}1.297686e{-}06}
\CommentTok{\#\textgreater{} 4  4 {-}1.043723e{-}06 0.006350496 {-}0.01292500 {-}8.878917e{-}07}
\CommentTok{\#\textgreater{}   0.975quant mode          kld}
\CommentTok{\#\textgreater{} 1 0.01293189   NA 3.960966e{-}08}
\CommentTok{\#\textgreater{} 2 0.01291878   NA 3.960951e{-}08}
\CommentTok{\#\textgreater{} 3 0.01292145   NA 3.960946e{-}08}
\CommentTok{\#\textgreater{} 4 0.01292212   NA 3.960945e{-}08}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{fit}\SpecialCharTok{$}\NormalTok{summary.hyperpar}
\CommentTok{\#\textgreater{}                                                 mean}
\CommentTok{\#\textgreater{} Precision for the Gaussian observations 3.803190e{-}03}
\CommentTok{\#\textgreater{} Precision for grower                    6.492375e+03}
\CommentTok{\#\textgreater{} Precision for box                       4.652606e+04}
\CommentTok{\#\textgreater{}                                                   sd}
\CommentTok{\#\textgreater{} Precision for the Gaussian observations 8.709997e{-}04}
\CommentTok{\#\textgreater{} Precision for grower                    7.735839e+03}
\CommentTok{\#\textgreater{} Precision for box                       2.559128e+04}
\CommentTok{\#\textgreater{}                                           0.025quant}
\CommentTok{\#\textgreater{} Precision for the Gaussian observations 2.220351e{-}03}
\CommentTok{\#\textgreater{} Precision for grower                    2.350166e+02}
\CommentTok{\#\textgreater{} Precision for box                       1.108515e+04}
\CommentTok{\#\textgreater{}                                             0.5quant}
\CommentTok{\#\textgreater{} Precision for the Gaussian observations 3.769612e{-}03}
\CommentTok{\#\textgreater{} Precision for grower                    3.886824e+03}
\CommentTok{\#\textgreater{} Precision for box                       4.164535e+04}
\CommentTok{\#\textgreater{}                                           0.975quant mode}
\CommentTok{\#\textgreater{} Precision for the Gaussian observations 5.601115e{-}03   NA}
\CommentTok{\#\textgreater{} Precision for grower                    2.787315e+04   NA}
\CommentTok{\#\textgreater{} Precision for box                       1.085357e+05   NA}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{fit}\SpecialCharTok{$}\NormalTok{summary.fixed}
\CommentTok{\#\textgreater{}                 mean       sd 0.025quant 0.5quant}
\CommentTok{\#\textgreater{} (Intercept) 358.1667 2.792823   352.6582 358.1667}
\CommentTok{\#\textgreater{}             0.975quant mode          kld}
\CommentTok{\#\textgreater{} (Intercept)   363.6751   NA 1.098478e{-}08}
\NormalTok{fit}\SpecialCharTok{$}\NormalTok{summary.hyperpar}
\CommentTok{\#\textgreater{}                                                mean}
\CommentTok{\#\textgreater{} Precision for the Gaussian observations 0.003774905}
\CommentTok{\#\textgreater{}                                                   sd}
\CommentTok{\#\textgreater{} Precision for the Gaussian observations 0.0008787604}
\CommentTok{\#\textgreater{}                                          0.025quant}
\CommentTok{\#\textgreater{} Precision for the Gaussian observations 0.002255845}
\CommentTok{\#\textgreater{}                                            0.5quant}
\CommentTok{\#\textgreater{} Precision for the Gaussian observations 0.003694988}
\CommentTok{\#\textgreater{}                                         0.975quant mode}
\CommentTok{\#\textgreater{} Precision for the Gaussian observations  0.0056879   NA}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\textgreater{} occasion    1.101333 0.01760830   1.066782 1.101336}
\CommentTok{\#\textgreater{}             0.975quant mode          kld}
\CommentTok{\#\textgreater{} (Intercept)   2.807060   NA 1.200732e{-}11}
\CommentTok{\#\textgreater{} occasion      1.135862   NA 5.550176e{-}12}
\NormalTok{fit}\SpecialCharTok{$}\NormalTok{summary.hyperpar}
\CommentTok{\#\textgreater{}                                             mean        sd}
\CommentTok{\#\textgreater{} Precision for the Gaussian observations 2.169714 0.1012859}
\CommentTok{\#\textgreater{} Precision for id                        1.286243 0.1092064}
\CommentTok{\#\textgreater{}                                         0.025quant 0.5quant}
\CommentTok{\#\textgreater{} Precision for the Gaussian observations   1.975811 2.167836}
\CommentTok{\#\textgreater{} Precision for id                          1.083694 1.281973}
\CommentTok{\#\textgreater{}                                         0.975quant mode}
\CommentTok{\#\textgreater{} Precision for the Gaussian observations   2.374797   NA}
\CommentTok{\#\textgreater{} Precision for id                          1.513669   NA}
...
\CommentTok{\#\textgreater{} Precision for Subject                   1314.751  571.882}
\CommentTok{\#\textgreater{} Precision for DayR                      6067.449 2128.981}
\CommentTok{\#\textgreater{}                                         0.025quant 0.5quant}
\CommentTok{\#\textgreater{} Precision for the Gaussian observations   1231.361 1558.540}
\CommentTok{\#\textgreater{} Precision for Subject                      520.880 1209.121}
\CommentTok{\#\textgreater{} Precision for DayR                        2819.867 5762.938}
\CommentTok{\#\textgreater{}                                         0.975quant mode}
\CommentTok{\#\textgreater{} Precision for the Gaussian observations   1950.856   NA}
\CommentTok{\#\textgreater{} Precision for Subject                     2728.298   NA}
...
\CommentTok{\#\textgreater{}    ID         mean         sd    0.025quant     0.5quant}
\CommentTok{\#\textgreater{} 1 308 {-}0.003768853 0.01446449 {-}0.0322858793 {-}0.003748471}
\CommentTok{\#\textgreater{} 2 309 {-}0.037614831 0.01485941 {-}0.0674454641 {-}0.037392656}
\CommentTok{\#\textgreater{} 3 310 {-}0.038204731 0.01487067 {-}0.0680609624 {-}0.037981029}
\CommentTok{\#\textgreater{} 4 330  0.028705889 0.01469936  0.0002843466  0.028533634}
\CommentTok{\#\textgreater{} 5 331  0.025993552 0.01465094 {-}0.0023753049  0.025835565}
\CommentTok{\#\textgreater{} 6 332  0.009899208 0.01447470 {-}0.0184009693  0.009836367}
\CommentTok{\#\textgreater{}     0.975quant mode          kld}
\CommentTok{\#\textgreater{} 1  0.024632642   NA 5.824642e{-}09}
\CommentTok{\#\textgreater{} 2 {-}0.009029182   NA 2.027919e{-}08}
\CommentTok{\#\textgreater{} 3 {-}0.009601909   NA 2.046447e{-}08}
\CommentTok{\#\textgreater{} 4  0.058095319   NA 1.427021e{-}08}
\CommentTok{\#\textgreater{} 5  0.055250994   NA 1.290467e{-}08}
\CommentTok{\#\textgreater{} 6  0.038554189   NA 6.836818e{-}09}
\FunctionTok{head}\NormalTok{(fit}\SpecialCharTok{$}\NormalTok{summary.random}\SpecialCharTok{$}\NormalTok{DayR)}
\CommentTok{\#\textgreater{}   ID         mean          sd   0.025quant     0.5quant}
\CommentTok{\#\textgreater{} 1  1 6.924175e{-}06 0.001501481 {-}0.002937713 6.924378e{-}06}
\CommentTok{\#\textgreater{} 2  2 1.056644e{-}02 0.004274275  0.002188709 1.055373e{-}02}
\CommentTok{\#\textgreater{} 3  3 2.106571e{-}02 0.008121901  0.005144074 2.103764e{-}02}
\CommentTok{\#\textgreater{} 4  4 3.184263e{-}02 0.012056266  0.008205546 3.180029e{-}02}
\CommentTok{\#\textgreater{} 5  5 4.249501e{-}02 0.016013229  0.011099078 4.243829e{-}02}
\CommentTok{\#\textgreater{} 6  6 5.322667e{-}02 0.019979612  0.014052981 5.315582e{-}02}
\CommentTok{\#\textgreater{}   0.975quant mode          kld}
\CommentTok{\#\textgreater{} 1 0.00295156   NA 5.527427e{-}11}
\CommentTok{\#\textgreater{} 2 0.01901743   NA 7.952064e{-}09}
\CommentTok{\#\textgreater{} 3 0.03714922   NA 1.020976e{-}08}
\CommentTok{\#\textgreater{} 4 0.05572393   NA 1.066174e{-}08}
\CommentTok{\#\textgreater{} 5 0.07421816   NA 1.083075e{-}08}
\CommentTok{\#\textgreater{} 6 0.09280918   NA 1.090778e{-}08}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\textgreater{}                                             mean       sd}
\CommentTok{\#\textgreater{} Precision for the Gaussian observations 142.0225  39.6761}
\CommentTok{\#\textgreater{} Precision for Lab                       349.8984 651.1169}
\CommentTok{\#\textgreater{} Precision for IDt                       206.0329 210.4745}
\CommentTok{\#\textgreater{} Precision for IDts                      366.9379 335.2802}
\CommentTok{\#\textgreater{}                                         0.025quant 0.5quant}
\CommentTok{\#\textgreater{} Precision for the Gaussian observations    77.8359 137.4888}
\CommentTok{\#\textgreater{} Precision for Lab                          22.4897 170.2001}
\CommentTok{\#\textgreater{} Precision for IDt                          26.6553 144.1389}
\CommentTok{\#\textgreater{} Precision for IDts                         59.8940 270.7238}
\CommentTok{\#\textgreater{}                                         0.975quant mode}
\CommentTok{\#\textgreater{} Precision for the Gaussian observations   232.9084   NA}
\CommentTok{\#\textgreater{} Precision for Lab                        1808.5615   NA}
\CommentTok{\#\textgreater{} Precision for IDt                         762.1450   NA}
\CommentTok{\#\textgreater{} Precision for IDts                       1256.5479   NA}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{round}\NormalTok{(fit}\SpecialCharTok{$}\NormalTok{summary.hyperpar,}\DecValTok{4}\NormalTok{)}
\CommentTok{\#\textgreater{}                                             mean       sd}
\CommentTok{\#\textgreater{} Precision for the Gaussian observations 141.9189  39.6194}
\CommentTok{\#\textgreater{} Precision for Lab                       349.8696 651.1149}
...
\CommentTok{\#\textgreater{}               mean    sd 0.025quant 0.5quant 0.975quant}
\CommentTok{\#\textgreater{} (Intercept) {-}3.591 0.190     {-}3.999   {-}3.578     {-}3.251}
\CommentTok{\#\textgreater{} psoe\_simp    3.086 0.187      2.724    3.084      3.456}
\CommentTok{\#\textgreater{} psoe\_past    2.352 0.186      1.990    2.352      2.718}
\FunctionTok{round}\NormalTok{(fit}\SpecialCharTok{$}\NormalTok{summary.hyperpar[,}\DecValTok{1}\SpecialCharTok{:}\DecValTok{5}\NormalTok{],}\DecValTok{3}\NormalTok{)}
\CommentTok{\#\textgreater{}                      mean      sd 0.025quant 0.5quant}
\CommentTok{\#\textgreater{} Precision for ccaa 70.789 250.922      1.978     10.7}
\CommentTok{\#\textgreater{}                    0.975quant}
\CommentTok{\#\textgreater{} Precision for ccaa    588.584}
\FunctionTok{head}\NormalTok{(}\FunctionTok{round}\NormalTok{(fit}\SpecialCharTok{$}\NormalTok{summary.fitted.values[,}\DecValTok{1}\SpecialCharTok{:}\DecValTok{5}\NormalTok{],}\DecValTok{3}\NormalTok{))}
\CommentTok{\#\textgreater{}                        mean    sd 0.025quant 0.5quant}
\CommentTok{\#\textgreater{} fitted.Predictor.0001 0.026 0.007      0.014    0.026}
\CommentTok{\#\textgreater{} fitted.Predictor.0002 0.033 0.007      0.022    0.032}
\CommentTok{\#\textgreater{} fitted.Predictor.0003 0.029 0.006      0.019    0.029}
\CommentTok{\#\textgreater{} fitted.Predictor.0004 0.029 0.006      0.019    0.029}
\CommentTok{\#\textgreater{} fitted.Predictor.0005 0.033 0.007      0.022    0.032}
\CommentTok{\#\textgreater{} fitted.Predictor.0006 0.882 0.023      0.835    0.883}
\CommentTok{\#\textgreater{}                       0.975quant}
\CommentTok{\#\textgreater{} fitted.Predictor.0001      0.040}
\CommentTok{\#\textgreater{} fitted.Predictor.0002      0.049}
\CommentTok{\#\textgreater{} fitted.Predictor.0003      0.042}
\CommentTok{\#\textgreater{} fitted.Predictor.0004      0.042}
\CommentTok{\#\textgreater{} fitted.Predictor.0005      0.049}
\CommentTok{\#\textgreater{} fitted.Predictor.0006      0.926}
\FunctionTok{head}\NormalTok{(}\FunctionTok{round}\NormalTok{(fit}\SpecialCharTok{$}\NormalTok{summary.linear.predictor[,}\DecValTok{1}\SpecialCharTok{:}\DecValTok{5}\NormalTok{],}\DecValTok{3}\NormalTok{))}
\CommentTok{\#\textgreater{}                  mean    sd 0.025quant 0.5quant 0.975quant}
\CommentTok{\#\textgreater{} Predictor.0001 {-}3.651 0.269     {-}4.242   {-}3.626     {-}3.181}
\CommentTok{\#\textgreater{} Predictor.0002 {-}3.394 0.209     {-}3.798   {-}3.398     {-}2.973}
\CommentTok{\#\textgreater{} Predictor.0003 {-}3.524 0.207     {-}3.951   {-}3.517     {-}3.131}
\CommentTok{\#\textgreater{} Predictor.0004 {-}3.524 0.207     {-}3.951   {-}3.517     {-}3.131}
\CommentTok{\#\textgreater{} Predictor.0005 {-}3.394 0.209     {-}3.798   {-}3.398     {-}2.973}
\CommentTok{\#\textgreater{} Predictor.0006  2.035 0.232      1.623    2.018      2.527}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{fit }\OtherTok{\textless{}{-}} \FunctionTok{inla}\NormalTok{(formula.inla,}\AttributeTok{family=}\StringTok{"poisson"}\NormalTok{, }
            \AttributeTok{data=}\NormalTok{ShipsIncidents, }\AttributeTok{offset=}\FunctionTok{log}\NormalTok{(months),}
            \AttributeTok{control.compute=}\FunctionTok{list}\NormalTok{(}\AttributeTok{return.marginals.predictor=}\ConstantTok{TRUE}\NormalTok{))}
\FunctionTok{round}\NormalTok{(fit}\SpecialCharTok{$}\NormalTok{summary.fixed[,}\DecValTok{1}\SpecialCharTok{:}\DecValTok{5}\NormalTok{],}\DecValTok{3}\NormalTok{)}
\CommentTok{\#\textgreater{}               mean    sd 0.025quant 0.5quant 0.975quant}
...
\begin{figure}
\centering
\includegraphics{03-glm_files/figure-latex/incidents1-1.pdf}
\caption{\label{fig:incidents1}Distribuciones posteriores de los coeficientes relativos al riesgo base e incremento relativo por tipo E}
\end{figure}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{formula }\OtherTok{\textless{}{-}}\NormalTok{ y }\SpecialCharTok{\textasciitilde{}} \DecValTok{1} \SpecialCharTok{+}\NormalTok{ built }\SpecialCharTok{+}\NormalTok{ oper }\SpecialCharTok{+}\NormalTok{ type}
\NormalTok{new.data }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{type=}\StringTok{"A"}\NormalTok{,}
                       \AttributeTok{built =}\StringTok{"70{-}74"}\NormalTok{, }
                       \AttributeTok{oper =} \StringTok{"75{-}79"}\NormalTok{,}
                       \AttributeTok{months=}\DecValTok{1500}\NormalTok{,}
                       \AttributeTok{y=}\ConstantTok{NA}\NormalTok{,}
                       \AttributeTok{id=}\ConstantTok{NA}\NormalTok{)}
\NormalTok{ships.combinado }\OtherTok{\textless{}{-}} \FunctionTok{rbind}\NormalTok{(ShipsIncidents,new.data) }

\DocumentationTok{\#\# creamos un vector con NA\textquotesingle{}s para observaciones y 1\textquotesingle{}s para predicciones}
\NormalTok{ships.indicador }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\FunctionTok{rep}\NormalTok{(}\ConstantTok{NA}\NormalTok{, }\FunctionTok{nrow}\NormalTok{(ShipsIncidents)), }\DecValTok{1}\NormalTok{)}
\DocumentationTok{\#\# reajustamos el modelo añadiendo la opción de predicción de datos}
\NormalTok{fit.pred }\OtherTok{\textless{}{-}} \FunctionTok{inla}\NormalTok{(formula, }\AttributeTok{family=}\StringTok{"poisson"}\NormalTok{,}\AttributeTok{data =}\NormalTok{ ships.combinado, }
                 \AttributeTok{offset=}\FunctionTok{log}\NormalTok{(months),}
                 \AttributeTok{control.compute=}\FunctionTok{list}\NormalTok{(}\AttributeTok{return.marginals.predictor=}\ConstantTok{TRUE}\NormalTok{),}
                 \AttributeTok{control.predictor =} \FunctionTok{list}\NormalTok{(}\AttributeTok{link =}\NormalTok{ ships.indicador))}
\DocumentationTok{\#\# y describimos los valores ajustados para los tres escenarios añadidos}
\NormalTok{fit.pred}\SpecialCharTok{$}\NormalTok{summary.fitted.values[}\FunctionTok{nrow}\NormalTok{(ships.combinado),]}
\CommentTok{\#\textgreater{}                         mean      sd 0.025quant 0.5quant}
\CommentTok{\#\textgreater{} fitted.Predictor.35 8.324152 1.37842   5.849265 8.246215}
\CommentTok{\#\textgreater{}                     0.975quant mode}
\CommentTok{\#\textgreater{} fitted.Predictor.35     11.247   NA}
\NormalTok{pred}\OtherTok{=}\NormalTok{fit.pred}\SpecialCharTok{$}\NormalTok{marginals.fitted.values[[}\FunctionTok{nrow}\NormalTok{(ships.combinado)]]}
\FunctionTok{ggplot}\NormalTok{(}\FunctionTok{as.data.frame}\NormalTok{(pred),}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{x,}\AttributeTok{y=}\NormalTok{y))}\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{()}\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x=}\StringTok{"Número de incidentes"}\NormalTok{,}\AttributeTok{y=}\StringTok{"D.Posterior"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{03-glm_files/figure-latex/unnamed-chunk-13-1.pdf}
